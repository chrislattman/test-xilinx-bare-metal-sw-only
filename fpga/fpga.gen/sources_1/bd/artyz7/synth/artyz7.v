...
(* CORE_GENERATION_INFO = "artyz7,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=artyz7,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "artyz7.hwdef" *) 
module artyz7
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  artyz7_axi_gpio_0_0 axi_gpio_0
  ...
  artyz7_axi_gpio_1_2 axi_gpio_1
  ...
  artyz7_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
